    ...
    initialize() {
        this.itemList = [
            new OakItem(OakItemType.Magic_Ball, 'Magic Ball', 'Gives a bonus to your catchrate',
                true, [5, 6, 7, 8, 9, 10], 0, 20, 2, undefined, undefined, undefined, '%', 101),
            new OakItem(OakItemType.Amulet_Coin, 'Amulet Coin', 'Gain more Pokédollars from battling',
                true, [1.25, 1.30, 1.35, 1.40, 1.45, 1.50], 1, 30, 1, undefined, undefined, undefined, undefined, 102),
            new OakItem(OakItemType.Rocky_Helmet, 'Rocky Helmet', 'Clicks do more damage',
                true, [1.25, 1.30, 1.35, 1.40, 1.45, 1.50], 1, 40, 3, undefined, undefined, undefined, undefined, 103),
            new OakItem(OakItemType.Exp_Share, 'EXP Share', 'Gain more exp from battling',
                true, [1.15, 1.18, 1.21, 1.24, 1.27, 1.30], 1, 50, 1, undefined, undefined, undefined, undefined, 104),
            new OakItem(OakItemType.Sprayduck, 'Sprayduck', 'Makes your berries grow faster',
                false, [1.25, 1.30, 1.35, 1.40, 1.45, 1.50], 1, 60, 1, undefined, undefined, undefined, undefined, 105),
            new OakItem(OakItemType.Shiny_Charm, 'Shiny Charm', 'Encounter shinies more often',
                true, [1.50, 1.60, 1.70, 1.80, 1.90, 2.00], 1, 70, 150, undefined, undefined, undefined, '%', 106),
            new OakItem(OakItemType.Magma_Stone, 'Magma Stone', 'Hatch eggs faster',
                false, [1.50, 1.60, 1.70, 1.80, 1.90, 2.00], 1, 80, 10, undefined, undefined, undefined, undefined, 107),
            new OakItem(OakItemType.Cell_Battery, 'Cell Battery', 'Reduce the charges needed to discharge',
                false, [-5, -10, -15, -20, -25, -30], 0, 90, 1, [5, 10, 30, 60, 150], undefined, undefined, ' Charges', 108),
