...
ItemList.Lickitung            = new PokemonItem('Lickitung', 1000, Currency.questPoint, false, undefined, {}, 'Lickitung');
ItemList['Pinkan Weezing']  = new PokemonItem('Pinkan Weezing');
ItemList['Pinkan Scyther']  = new PokemonItem('Pinkan Scyther');
ItemList['Mr. Mime']             = new PokemonItem('Mr. Mime', 1000, Currency.questPoint, false, undefined, {}, 'Mr. Mime');
ItemList['Pinkan Electabuzz']  = new PokemonItem('Pinkan Electabuzz');
ItemList.Jynx                 = new PokemonItem('Jynx', 2000, Currency.questPoint, false, undefined, {}, 'Jynx');
ItemList.Magikarp             = new PokemonItem('Magikarp', 50000, Currency.money, true, undefined, {}, 'Magikarp');
...
ItemList.Eevee                = new PokemonItem('Eevee', 4000, Currency.questPoint, false, undefined, {}, 'Eevee');
ItemList.Porygon              = new PokemonItem('Porygon', 2000, Currency.questPoint, false, undefined, {}, 'Porygon');
