...
def viridian_forest(world: World, state: CollectionState, player: int):
    """Checks if the player can access Viridian Forest."""
    return kanto_route_2(world, state, player)
...
def pewter_city(world: World, state: CollectionState, player: int):
    ...
    return viridian_forest(world, state, player) and has_dungeon_ticket
...
def mt_moon(world: World, state: CollectionState, player: int):
...
def kanto_route_4(world: World, state: CollectionState, player: int):
    ...
    has_dungeon_ticket = state.count("Dungeon Ticket", player) > 0
    return mt_moon(world, state, player) and has_dungeon_ticket
...
def digletts_cave(world: World, state: CollectionState, player: int):
...
def power_plant(world: World, state: CollectionState, player: int):
    """Checks if the player can access the Power Plant."""
    has_soul_badge = state.count("Soul Badge", player) > 0
    return kanto_route_9(world, state, player) and has_soul_badge
...
def rock_tunnel(world: World, state: CollectionState, player: int):
    """Checks if the player can access Rock Tunnel."""
    return kanto_route_10(world, state, player)

def lavender_town(world: World, state: CollectionState, player: int):
    """Checks if the player can access Lavender Town."""
    has_dungeon_ticket = state.count("Dungeon Ticket", player) > 0
    return rock_tunnel(world, state, player) and has_dungeon_ticket

def pokemon_tower(world: World, state: CollectionState, player: int):
    """Checks if the player can access Pokemon Tower."""
    return lavender_town(world, state, player) and celadon_city(world, state, player)
...
def silph_co(world: World, state: CollectionState, player: int):
    """Checks if the player can access the Sylph Co. building."""
    has_dungeon_ticket = state.count("Dungeon Ticket", player) > 0
    return saffron_city(world, state, player) and pokemon_tower(world, state, player) and has_dungeon_ticket
...
def rocket_game_corner(world: World, state: CollectionState, player: int):
    """Checks if the player can access the Rocket Game Corner."""
    return celadon_city(world, state, player)

def kanto_route_13(world: World, state: CollectionState, player: int):
    """Checks if the player can access Kanto Route 13."""
    has_dungeon_ticket = state.count("Dungeon Ticket", player) > 0
    return (pokemon_tower(world, state, player) and has_dungeon_ticket)
...
def seafoam_islands(world: World, state: CollectionState, player: int):
    """Checks if the player can access Seafoam Islands."""
    has_rainbow_badge = state.count("Rainbow Badge", player) > 0
    return kanto_route_19(world, state, player) and has_rainbow_badge
...
def kanto_route_20(world: World, state: CollectionState, player: int):
    ...
    return kanto_route_21(world, state, player) or (seafoam_islands(world, state, player) and had_dungeon_ticket)
...
def pokemon_mansion(world: World, state: CollectionState, player: int):
    """Checks if the player can access the Pokemon Mansion."""
    return cinnabar_island(world, state, player)
...
def mount_ember(world: World, state: CollectionState, player: int):
    """Checks if the player can access Mount Ember on Sevii One Island."""
    return kindle_road(world, state, player)
...
def can_get_water_egg(world: World, state: CollectionState, player: int) -> bool:
    ...
    return cerulean_city(world, state, player)
...
def can_get_mystery_egg(world: World, state: CollectionState, player: int) -> bool:
    ...
    return enabled and pewter_city(world, state, player)
...
def completed_bills_errand(world: World, state: CollectionState, player: int):
    ...
    return cinnabar_island(world, state, player) and one_island(world, state, player) and two_island(world, state, player) and three_island(world, state, player)
...
def completed_bills_grandpas_treasure_hunt(world: World, state: CollectionState, player: int):
    ...
    has_dungeon_ticket = state.count("Dungeon Ticket", player) > 0
    return ((kanto_route_3(world, state, player)) and # Jigglypuff 
        ...
        (kanto_route_8(world, state, player) or kanto_route_7(world, state, player) or (pokemon_mansion(world, state, player) and has_dungeon_ticket)) and #Growlithe
        ((viridian_forest(world, state, player) or power_plant(world, state, player)) and has_dungeon_ticket)) # Pikachu
...
def can_catch_x_pokemon(world: World, state: CollectionState, player: int, x: int):
    ...
    has_dungeon_ticket = state.count("Dungeon Ticket", player) > 0
    if has_dungeon_ticket:
        if viridian_forest(world, state, player) and has_dungeon_ticket:
    ...
    if num_badges >= 2:
        ...
        if "Tangela" in catch_set:
            catch_set.add('Tangrowth')
